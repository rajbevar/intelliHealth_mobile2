package com.healthcare.bosch.patientapp.libs.calendardayview;
...
public class PopupView extends FrameLayout {
    ...
    protected ImageView image_start;
    ...
    public void setPopup(IPopup popup) {
        ...
        if (popup.getQuote().equalsIgnoreCase("not taken")) {
            image_start.setImageDrawable(getContext().getResources().getDrawable(R.drawable.ic_dot));
        } else if (popup.getQuote().equalsIgnoreCase("taken")) {
            image_start.setImageDrawable(getContext().getResources().getDrawable(R.drawable.active));
        } else if (popup.getQuote().equalsIgnoreCase("not taken1")) {
            image_start.setImageDrawable(getContext().getResources().getDrawable(R.drawable.inactive));
        }
